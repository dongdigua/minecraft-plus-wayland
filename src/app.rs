...
use crate::{
    modules::{
        AlphaFluidVariant, AlphaFluidsModule, BlocksModule, CreeperModule, FootprintModule,
        FrameInfo, GrassModule, LoadCubeModule, Module, PanoramaModule, RenderSize, SquidModule,
        TriangleModule,
    },
        ...
        match argument.as_str() {
            ...
            "--module" => {
                ...
                module = match module_id {
                    ...
                    1..=3 | 9 => {
                        return Err(format!(
                            "module={module_id} is not implemented natively; only module=0 (load cube), module=4 (alpha fluids water), module=5 (alpha fluids lava), module=6 (panorama), module=7 (footprint), module=8 (squid), module=10 (grass), module=11 (blocks), and module=12 (creeper) are available"
                        )
                        .into());
                    }
                    _ => {
